...
public class DesUtils {
     ...
     * @throws Exception
     */
    public DesUtils(String strKey) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
    ...
    public static String decryptToken(String token, String... key) throws BadPaddingException, IllegalBlockSizeException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        DesUtils des = new DesUtils(key.length == 1 ? key[0] : strDefaultKey);//自定义密钥
        return des.decrypt(token);

    }


    public static String encryptToken(String token, String... key) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        DesUtils des = new DesUtils(key.length == 1 ? key[0] : strDefaultKey);//自定义密钥
