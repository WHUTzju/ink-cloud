package cn.hyperchain.common.exception.util;


import cn.hyperchain.common.exception.ErrorCode;
import cn.hyperchain.common.exception.ServiceException;
...
/**
 * {@link cn.hyperchain.common.exception.ServiceException} 工具类
 *
 * 目的在于，格式化异常信息提示。
